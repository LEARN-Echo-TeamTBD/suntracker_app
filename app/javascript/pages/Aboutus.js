            ...
            <React.Fragment>
                <div className='problem-statement'>
                    <blockquote className='blockquote text-center'>
                        <p className='mb-0'>
                            It is estimated that approximately 9,500 people in
                            the U.S. are diagnosed with skin cancer every day.
                        </p>
                        <footer id='cuztomiz-blockquote-footer'>
                            -Rogers HW, Weinstock MA, Feldman SR, Coldiron BM.
                            Incidence estimate of nonmelanoma skin cancer
                            (keratinocyte carcinomas) in the US population,
                            2012. JAMA Dermatol 2015
                ...
                <div className='our-team'>
                                    ...
                                    <div className='team-card-style-1 mx-auto'>
                                        <div className='team-card-inner'>
                                            ...
                                            <ul className='team-social-bar-list'>
                                                <li>
                                                    <a
                                                        className='social-btn sb-style-4'
                    ...
                    <div className='about-sun-tracker'>
                        ...
                        <p>
                            {' '}
                            We have designed a simple tracker system that allows
                            our users to log in daily sun exposure data helping
                            them stay on top of their sun exposure. Users can:
                        </p>
                        <ul>
