          ...
          <div className="container">
                <div className="row pb-5">
                  <div className="col-xl-3 col-sm-6">
                        ...
                        <div className="team-thumb"><img src="https://demo.createx.studio/createx/img/team/style-1/01.jpg" alt="Team Member Picture" />
                        </div>
                        ...
                        <div className="team-social-bar text-center"><a className="social-btn sb-style-4 sb-twitter" href="github.com"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" height="42" width="42" /></a><a className="social-btn sb-style-4 sb-github" href="#"><i className="socicon-github"></i></a><a className="social-btn sb-style-4 sb-stackoverflow" href="#"><i className="socicon-stackoverflow"></i></a><a className="social-btn sb-style-4 sb-skype" href="#"><i className="socicon-skype"></i></a></div>
